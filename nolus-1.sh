...
GENESIS=https://raw.githubusercontent.com/Nolus-Protocol/nolus-networks/main/testnet/nolus-rila/genesis.json
ADDRBOOK=https://snapshots1-testnet.nodejumper.io/nolus-testnet/addrbook.json
PORT=06
...
s|^(trust_hash[[:space:]]+=[[:space:]]+).*$|\1\"$TRUST_HASH\"|" $HOME/$FOLDER/config/config.tom
