...
GENESIS=https://snapshots.polkachu.com/genesis/terra/genesis.json
ADDRBOOK=https://snapshots.polkachu.com/addrbook/terra/addrbook.json
PORT=10
...
SNAP_NAME=$(curl -s https://snapshots.polkachu.com/snapshots/terra/ | egrep -o ">20.*\.tar.lz4" | tr -d ">")
curl -o - -L https://snapshots.polkachu.com/snapshots/terra/${SNAP_NAME}  | lz4 -c -d - | tar -x -C $HOME/$FOLDER
